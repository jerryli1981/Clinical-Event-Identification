...
from utils import read_char_encoding_sequence_dataset, iterate_minibatches_,loadWord2VecMap, generateTestInput_Char
...
if __name__ == '__main__':
    ...
    if args.mode == "train":
        ...
        _, _,seqlen, num_feats = read_char_encoding_sequence_dataset(data_dir, "dev")
        ...
        for dir_path, dir_names, file_names in os.walk(input_text_test_dir):
            ...
            for i, fn in enumerate(file_names):
                ...
                spans, features = generateTestInput_Char(data_dir, input_text_test_dir, fn, window_size, num_feats)
